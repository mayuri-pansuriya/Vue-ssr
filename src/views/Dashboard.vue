  ...
  data() {
    return {
      ...
      tableItems: [
        {
          avatar: {
            url: `${this.$store.state.common.publicPath}img/avatars/1.jpg`,
            status: "success"
          },
          user: {
        ...
        {
          avatar: {
            url: `${this.$store.state.common.publicPath}img/avatars/2.jpg`,
            status: "danger"
          },
          user: {
            name: "Avram Tarasios",
        ...
        {
          avatar: {
            url: `${this.$store.state.common.publicPath}img/avatars/3.jpg`,
            status: "warning"
          },
        ...
        {
          avatar: {
            url: `${this.$store.state.common.publicPath}img/avatars/4.jpg`,
            status: ""
          },
        ...
        {
          avatar: {
            url: `${this.$store.state.common.publicPath}img/avatars/5.jpg`,
            status: "success"
          },
          user: {
        ...
        {
          avatar: {
            url: `${this.$store.state.common.publicPath}img/avatars/6.jpg`,
            status: "danger"
          },
          user: {
            name: "Friderik Dávid",
